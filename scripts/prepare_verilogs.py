...
palabras = ["ALTDDIO_IN", "ALTDDIO_OUT", "DFF", "DFFE", "ALTPLL",
            ...
            "ARESET", "CLKENA", "EXTCLKENA", "FBIN", "INCLK", "PFDENA", "PLLENA",
            "CLK", "LOCKED"
           ]
...
import re
for p in palabras:
    texto = re.sub(rf'\b{p}\b', p.lower(), texto)
